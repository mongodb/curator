...
func TestBSONRoundtrip(t *testing.T) {
	...
	cmd := exec.Command("../build/curator", "ftdc", "frombson", "--input", bsonOriginal, "--output", ftdcFromOriginal)
	_, err = cmd.CombinedOutput()
	require.NoError(t, err)

	cmd = exec.Command("../build/curator", "ftdc", "tobson", "--input", ftdcFromOriginal, "--output", bsonRoundtrip)
	_, err = cmd.CombinedOutput()
	require.NoError(t, err)
...
func TestJSONRoundtrip(t *testing.T) {
	...
	cmd = exec.Command("../build/curator", "ftdc", "tojson", "--input", ftdcFromOriginal+".0", "--output", jsonRoundtrip)
	_, err = cmd.CombinedOutput()
	require.NoError(t, err)
