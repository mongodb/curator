...
func (*IntervalSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_735bd811beec5ec9, []int{0}
}
...
func (*SummaryIntegerSlice) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_735bd811beec5ec9, []int{1}
}
...
func (*SummaryInteger) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_735bd811beec5ec9, []int{2}
}
...
func (*SummaryDoubleSlice) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_735bd811beec5ec9, []int{3}
}
...
func (*SummaryDouble) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_735bd811beec5ec9, []int{4}
}
...
func init() { proto.RegisterFile("metrics.proto", fileDescriptor_metrics_735bd811beec5ec9) }

var fileDescriptor_metrics_735bd811beec5ec9 = []byte{
