...
func (*EventSendTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorder_b342897f31ff520e, []int{0}
}
...
func (*EventSendInt) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorder_b342897f31ff520e, []int{1}
}
...
func (*EventSendBool) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorder_b342897f31ff520e, []int{2}
}
...
func (*EventSendDuration) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorder_b342897f31ff520e, []int{3}
}
...
func init() { proto.RegisterFile("recorder.proto", fileDescriptor_recorder_b342897f31ff520e) }

var fileDescriptor_recorder_b342897f31ff520e = []byte{
